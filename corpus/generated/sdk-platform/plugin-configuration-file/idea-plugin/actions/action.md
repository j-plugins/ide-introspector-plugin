...
---
Part of `sdk.plugin-configuration-file.idea-plugin.actions`.
...
> Source: IntelliJ Platform SDK docs — Plugin Configuration File: action (build 261.24374.151). https://plugins.jetbrains.com/docs/intellij/llms.txt
