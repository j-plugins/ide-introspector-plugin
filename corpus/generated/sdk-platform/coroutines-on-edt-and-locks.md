...
Sometimes, errors similar to the below can be observed in the IDE running in the [internal mode](https://plugins.jetbrains.com/docs/intellij/enabling-internal.html):
