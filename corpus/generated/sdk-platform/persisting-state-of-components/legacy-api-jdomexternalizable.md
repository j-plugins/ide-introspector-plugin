...
> Source: IntelliJ Platform SDK docs — Persisting State of Components: Legacy API (`JDOMExternalizable`) (build 261.24374.151). https://plugins.jetbrains.com/docs/intellij/llms.txt
