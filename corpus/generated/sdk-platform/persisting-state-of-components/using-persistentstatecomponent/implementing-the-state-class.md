...
> Source: IntelliJ Platform SDK docs — Persisting State of Components: Implementing the State Class (build 261.24374.151). https://plugins.jetbrains.com/docs/intellij/llms.txt
