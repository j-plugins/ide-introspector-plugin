...
> Source: IntelliJ Platform SDK docs — Custom Settings Groups: Extension Points for Parent-Child Settings Relationships (build 261.24374.151). https://plugins.jetbrains.com/docs/intellij/llms.txt
